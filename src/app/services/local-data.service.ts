...
export class LocalDataService {
  ...
  currentUser: any = {"ID":77,"name":"GautamS","displayName":"GAUTAM C SANTOKI","profile":"Agent","token":"a8031cce-1675-44","response":"Success!"};
  currentDiv: any =     {
    "name": "Dummy Juliet Division",
    "db": "bak_Juliet",
    "email": "vinodtank.sl@gmail.com",
    "setQty": "1"
  };
